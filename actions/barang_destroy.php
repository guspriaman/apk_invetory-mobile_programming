...
$execute = mysqli_query($connect, $query) or die(response(500, "Unable to delete barang", 'fail', mysqli_error($connect)));
return response(200, "Barang berhasil dihapus", "ok");
